...
from wtforms import StringField, PasswordField, DateField, SubmitField, TextAreaField, SelectField, DateTimeField, IntegerField, DateTimeLocalField
...
class QuestionForm(FlaskForm):
    ...
    correct_option = IntegerField('Correct Option from (1-4)', validators=[DataRequired()])
